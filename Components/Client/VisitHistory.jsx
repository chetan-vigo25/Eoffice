...
import { StatusBar, View, Text, TouchableOpacity, Animated, SafeAreaView, RefreshControl, Platform, ScrollView, ToastAndroid, ActivityIndicator } from "react-native";
                    ...
                    <View style={{ marginTop:5 }} >
                      {
                        ...
                        <View style={{ width:'70%', height:40, justifyContent:'center', alignItems:'center', backgroundColor:item.status === "confirmed"?'#dbffd2':'#ffdddd', borderRadius:6 }} >
                          <Text style={{ fontSize: 14, fontFamily: "Poppins-SemiBold", color:item.status === "confirmed"?'#34a32a':'#c32c2c' }} >{item.status === "confirmed"? 'Metting Successful': 'Cancelled By You'}</Text>
                        </View>:null
                      }
                    </View>
                  </View>
