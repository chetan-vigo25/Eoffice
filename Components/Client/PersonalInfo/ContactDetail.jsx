             ...
             <View style={{ width:'100%', marginBottom:10, backgroundColor:Style.basicbgColor, padding:10, borderRadius:10, elevation:2 }} >
               <View>
                 ...
                 <View style={{ width:'100%', justifyContent:"center", borderRadius:5, backgroundColor:Style.inputBgColor, elevation:1, marginBottom:10, padding:5, elevation:4 }}>
                   <Text style={{ color: Style.placeHolderTextColor, fontWeight: '500', fontSize: 14, padding:8 }}>{personalInfoData?.clientProfile?.contactInfo?.email || "No email available" }</Text>
                 </View>
               </View>
               <View>
                 <Text style={{ fontSize:12, fontWeight:500, color:Style.secondryTextColor, paddingBottom:5 }}>Designation</Text>
                 <View style={{ width:'100%', justifyContent:'center', borderRadius:5, backgroundColor:Style.inputBgColor, elevation:1, marginBottom:10, padding:5, elevation:4 }}>
                  <Text style={{ color: Style.placeHolderTextColor, fontWeight: '500', fontSize: 14, padding:8 }}>{personalInfoData?.clientProfile?.contactInfo?.designation || "No designation available" }</Text>
                 </View>
               </View>
              <View>
               <Text style={{ fontSize:12, fontWeight:500, color:Style.secondryTextColor, paddingBottom:5 }}>Phone No.</Text>
                <View style={{ flexDirection:'row', gap:10, marginBottom:10,  }} >
                  ...
                  <View style={{ flex:8, justifyContent:'center', backgroundColor:Style.inputBgColor, borderRadius:5, justifyContent:'center', alignItems:'flex-start', paddingLeft:10, elevation:4 }} >
                   <Text style={{ color: Style.placeHolderTextColor, fontWeight: '500', fontSize: 14, padding:8 }} >{personalInfoData?.clientProfile?.contactInfo?.number || "No number available" }</Text>
                  </View>
                </View>
              </View>
             </View>
