    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#6a8ff3' }}>
       <StatusBar backgroundColor={'#6a8ff3'} barStyle='light-content' />
        ...
        <View style={{ flex:1, backgroundColor:'#fff', borderTopLeftRadius:20, borderTopRightRadius:20, }} >
            ...
            <View style={{ width:'100%', backgroundColor:'#f1f1f190', padding:10, borderRadius:10,  }} >
            ...
            <View>
             <View style={{ flexDirection:'row', gap:10, justifyContent:'space-between', alignItems:'center', marginTop:10, marginBottom:10 }} >
               <View style={{ flex:1, borderRadius:6, backgroundColor:'#f1f1f190', justifyContent:'center', alignItems:'center', padding:20 }} >
                   ...
                   <View style={{ flex:1, justifyContent:'center',  backgroundColor:'#ffffff80', padding:10 }} >
                     <View style={{ width:'100%', backgroundColor:'#fff', padding:20, borderRadius:10, shadowOffset: { width: 0, height: 5, }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 5, }} >
                        ...
                        <View style={{ flexDirection:'row', gap:20 }} >
                          ...
                          <TouchableOpacity onPress={() => setLogoutModalVisible(false)} style={{ flex:1, height:40, justifyContent:'center', alignItems:'center', backgroundColor:'#6a8ff3', borderWidth:1, borderColor:'#6a8ff3', borderRadius:6 }} >
             ...
             <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom:10 }} >
              <View style={{ flexDirection:'row', gap:5, justifyContent:'space-between', marginBottom:10, padding:10 }} >
              {tabs.map(tab => {
                    ...
                    <View>
                      ...
                      <Text style={{ fontSize:16, fontFamily:"Poppins-SemiBold", color:'#6a8ff3', }} >Personal Information</Text>
                        ...
                        <View style={{ flexDirection:'row', gap:5, alignItems:'center',  marginBottom:10 }} >
                          ...
                          <Text style={{flex:1, fontSize:12, fontFamily:"Poppins-Medium", color:'#444' }} >{onBoardingData?.generalInfo?.probationPeriod === null? 'N/A' : onBoardingData?.probationPeriod}</Text>
                        </View>
                        <View style={{ flexDirection:'row', gap:5, alignItems:'center',  marginBottom:10 }} >
                          <Entypo name="v-card" size={16} color="#6a8ff3" />
                  ...
                  <View style={{ width:'100%', padding:10,backgroundColor:'#f1f1f190', borderRadius:6, marginVertical:0 }} >
                    ...
                    <View style={{ flexDirection:'row', gap:5, alignItems:'center', marginBottom:10}} >
                      <View style={{ flex:1 }} >
                        ...
                        <Text style={{ fontSize:12, fontFamily:"Poppins-Medium", color:'#444', paddingLeft:20 }} >BCA</Text>
                      </View>
                      <View style={{ flex:1 }} >
                        <View style={{ flexDirection:'row', alignItems:'center', gap:5 }} >
                        ...
                        <Text style={{ fontSize:12, fontFamily:"Poppins-Medium", color:'#444', paddingLeft:20 }} >RU</Text>
                      </View>
                    </View>
                    <View style={{ flexDirection:'row', gap:5, alignItems:'center', marginBottom:10}} >
                      <View style={{ flex:1 }} >
                        ...
                        <Text style={{ fontSize:12, fontFamily:"Poppins-Medium", color:'#444', paddingLeft:20 }} >01-07-2022</Text>
                      </View>
                      <View style={{ flex:1 }} >
                        <View style={{ flexDirection:'row', alignItems:'center', gap:5 }} >
                          <Ionicons name="calendar" size={12} color="#6a8ff3" />
                        ...
                        <Text style={{ fontSize:12, fontFamily:"Poppins-Medium", color:'#444', paddingLeft:20 }} >01-07-2025</Text>
                      </View>
                    </View>
                    <View style={{ flexDirection:'row', gap:5, alignItems:'center',}} >
                      {/* <View style={{ flex:.7 }} >
                        <View style={{ flexDirection:'row', alignItems:'center', gap:5 }} >
                          <Ionicons name="calendar" size={12} color="#6a8ff3" />
                          <Text style={{ fontSize:12, fontFamily:"Poppins-SemiBold", color:'#444' }} >Marking in</Text>
                        </View>
                        <Text style={{ fontSize:12, fontFamily:"Poppins-Medium", color:'#444', paddingLeft:20 }} >Percentage</Text>
                      </View> */}
                      <View style={{ flex:.9 }} >
                        <View style={{ flexDirection:'row', alignItems:'center', gap:5 }} >
                        ...
                        <Text style={{ fontSize:12, fontFamily:"Poppins-Medium", color:'#444', paddingLeft:20 }} >99.99</Text>
                      </View>
                      <View style={{ flex:1 }} >
                        <View style={{ flexDirection:'row', alignItems:'center', gap:5 }} >
                          <FontAwesome name="percent" size={12} color="#6a8ff3" />
                        ...
                        <Text style={{ fontSize:12, fontFamily:"Poppins-Medium", color:'#444', paddingLeft:20 }} >Computer Application</Text>
                      </View>
                    </View>
                    </View>
                  </View>
                  ...
                  <View style={{ width:'100%', padding:10,backgroundColor:'#f1f1f190', borderRadius:6, marginVertical:0 }} >
                    ...
                    <View style={{ flexDirection:'row', gap:5, alignItems:'center', marginBottom:10}} >
                      <View style={{ flex:1 }} >
                        ...
                        <Text style={{ fontSize:12, fontFamily:"Poppins-Medium", color:'#444', paddingLeft:20 }} >Concept Tek Solution</Text>
                      </View>
                      <View style={{ flex:1 }} >
                        <View style={{ flexDirection:'row', alignItems:'center', gap:5 }} >
                          <Entypo name="graduation-cap" size={12} color="#6a8ff3" />
                        ...
                        <Text style={{ fontSize:12, fontFamily:"Poppins-Medium", color:'#444', paddingLeft:20 }} >Developer</Text>
                      </View>
                    </View>
