...
export default function EmployeIcard({ navigation, route }) {
  ...
  const icardTemplate = async () => {
    try {
      ...
      console.error("Error fetching i-card template:", error);
...
//   }, []);
 ...
 const downloadIcardPDF = async () => {
     ...
     try {
       ...
       setLoading(false);
       showToast("Icard generated");
       if (await Sharing.isAvailableAsync()) {
         await Sharing.shareAsync(uri, {
           mimeType: 'application/pdf',
           dialogTitle: 'Icard PDF',
           UTI: 'com.adobe.pdf',
         });
       } else {
